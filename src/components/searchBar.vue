...
<template>
    <form @submit.prevent="searchBrewery">
        <label for="default-search" class="mb-2 text-sm font-medium text-brown-900 sr-only dark:text-white">Search</label>
        <div class="relative">
            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                <svg class="w-4 h-4 text-brown-500 dark:text-brown-400" aria-hidden="true"
